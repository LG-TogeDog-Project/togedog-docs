...
공개용 전체 문서는 [`reports/TogeDog_Final_Report_Public.pdf`](./reports/TogeDog_Final_Report_Public.pdf)에서 확인할 수 있습니다. 원본의 내부 WBS 링크와 개인 문서 메타데이터만 제거했으며, 프로젝트 본문 77페이지와 공개 참고문헌은 유지했습니다.
